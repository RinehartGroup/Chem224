# Chem224 - Lecture 7.2 - In Class - Group Work
...
a. Show the crystal field splitting orbital picture for the free ion, weak field, and strong field cases of $O_h$ symmetry. (This is just adding electrons to the d-orbitals in the ground state configuration.) What are S and L for each case? Are weak and strong-field cases different ground states? If not, what is an oxidation state of Co that would lead to a difference in the ground state between weak and strong field cases?

b. For the weak and strong field cases, suggest a type of ligand and example that might lead to that type of splitting. (It is OK if it isn't chemically reasonable for other reasons like sterics or charge balance - just consider the bonding for now.)
